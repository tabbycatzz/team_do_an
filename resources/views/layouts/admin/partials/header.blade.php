        ...
        <ul class="nav navbar-nav float-right">
          ...
          <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="javascript:void(0);" data-toggle="dropdown">
              <div class="user-nav d-sm-flex d-none">
                  <span class="user-name">{{ Auth::guard('admin')->user()->userProfile->full_name }}</span>
                  <span class="user-status text-muted">Available</span>
              </div>
              <span>
                @if (Auth::guard('admin')->user()->userProfile->avatar != null)
                  <img
                    class="round"
                    src="{{ asset('/storage/images/avatar/'.Auth::guard('admin')->user()->userProfile->avatar) }}"
                    alt="avatar"
                    height="40"
                    width="40"
                  >
                @elseif (Auth::guard('admin')->user()->userProfile->gender == \App\Enums\Genre::MALE)
                  <img class="round" src="/admin/app-assets/images/avatar-male.png" alt="avatar" height="40" width="40">
                @else
                  <img class="round" src="/admin/app-assets/images/avatar-female.png" alt="avatar" height="40" width="40">
                @endif
              </span>
            </a>
            <div class="dropdown-menu dropdown-menu-right pb-0">
              ...
              <a class="dropdown-item" href="{{ route('admin.options.setting') }}">
                <i class="bx bx-check-square mr-50"></i> Setting
              </a>
              <a class="dropdown-item" href="{{ route('admin.options.index') }}">
                <i class="bx bxs-id-card mr-50"></i> About Us
              </a>
